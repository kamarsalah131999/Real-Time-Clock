...
void LCD_vinit ()
{
	...
	DIO_vset_pin_dir('A',6,1);                      //pin 6 on port A is output
	DIO_vset_pin_dir('A',7,1);                     //pin 7 on port A is output
	DIO_vset_pin_dir('A',EN,1);                   //pin 0 on port A is output
	DIO_vset_pin_dir('A',RW,1);                  //pin 1 on port A is output
	DIO_vset_pin_dir('A',RS,1);                 //pin 2 on port A is output
	DIO_vwrite_pin('A',RW,0);                  // RW=0 to send commands
...
{
	DIO_vwrite_pin('A',EN,1);          // conected enable with pin 1 on port A
	_delay_ms(2);
